#pip install torch transformers datasets evaluate huggingface_hub tqdm pillow wandb
#python phi4-image-dataset-prep.py --input_dir ./image_dataset --output_dir ./phi4_datasets --include_multi_label
#python phi4-image-classifier.py \
  --model_name "microsoft/Phi-4-vision" \
  --train_data "./phi4_datasets/train.json" \
  --val_data "./phi4_datasets/val.json" \
  --output_dir "./phi4_model" \
  --batch_size 4 \
  --num_epochs 3

#chmod +x phi4-dataset-usage-script.sh
./phi4-dataset-usage-script.sh --input_dir ./image_dataset
